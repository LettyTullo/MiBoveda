...
A continuación se explica su funcionamiento paso a paso según las fuentes:
...
Una ventaja clave de este sistema es que permite la **decodificación de decisión suave**, donde el receptor no asigna inmediatamente un "0" o "1" a un voltaje, sino que utiliza la incertidumbre de la señal para mejorar la corrección de errores en toda la secuencia. Se utilizan ampliamente en estándares como **GSM (telefonía móvil)**, comunicaciones por satélite y **IEEE 802.11 (Wi-Fi)**.