...
>- **10Base-T:** Utiliza cable de **par trenzado (UTP)** conectado a un dispositivo central llamado **hub (concentrador)**. 

>[!important]
>El HUB: actúa como un repetidor de bits: cualquier señal recibida en un puerto se retransmite a todos los demás, formando un único **dominio de colisión**.

2. Subcapa MAC y CSMA/CD
